# -*- coding: utf-8 -*-
"""Cross_section_squareduct.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1cJGnq-g5zjbEuHcafW2v8Xs5GlbDsj2k
"""
...
# Commented out IPython magic to ensure Python compatibility.
# %pip -q install "git+https://github.com/KevinMoonLab/SymmetryML.git@main#egg=symdisc"
...
from symdisc.enforcement.regularization import as_field_lastdim, make_pairer
...
model, tr_hist, te_hist = run_squareduct_training(
     train_npz_paths=[
         ...
         "squareDuct_1100_mandel_r0.0200.npz"
     ],
     test_npz_paths=[
...
model2, tr_hist2, te_hist2 = run_squareduct_training(
     train_npz_paths=[
         #"graphs_r/squareDuct_1100_r0.0500.npz",
         #"graphs_r/squareDuct_1500_r0.0500.npz",
         "squareDuct_1100_mandel_r0.0200.npz"
...
model3, tr_hist3, te_hist3 = run_squareduct_training(
     train_npz_paths=[
         #"graphs_r/squareDuct_1100_r0.0500.npz",
         #"graphs_r/squareDuct_1500_r0.0500.npz",
         "squareDuct_1100_mandel_r0.0200.npz"
